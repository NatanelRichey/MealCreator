...
mealPageContainer.addEventListener('mousedown', function (e) {
    if (e.target.nodeName === "INPUT" && e.target.className.includes('trash-btn')) {
        isClickingButton = true
    }
})

// Reset after click completes
mealPageContainer.addEventListener('mouseup', function (e) {
