    ...
    <nav className="fixed top-0 left-0 right-0 bg-white shadow-sm z-50">
      <div className="container mx-auto px-4">
        <div className="flex items-center justify-between h-16">
          ...
          {/* Mobile Hamburger - Visible only on mobile, hidden on medium+ screens */}
          <button
        ...
        {isMenuOpen && (
          <div className="md:hidden fixed top-16 left-0 right-0 bg-white shadow-lg border-t" style={{ zIndex: 9999 }}>
